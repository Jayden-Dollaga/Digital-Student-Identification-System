...
## End-to-end DSIS architecture overview

The following diagram captures the complete DSIS flow from user interaction through the desktop app, Python backend, device services, firmware, sensor hardware, and persisted attendance state. It is intended as a high-level system map for the current maintained runtime and should be read alongside the more detailed v3 architecture documents.
...
This visual map complements the architecture documents in this folder and acts as an end-to-end reference for how the project is structured and how data moves from hardware input to application behavior.
